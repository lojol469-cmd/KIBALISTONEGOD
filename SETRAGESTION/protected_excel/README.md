---
title: Système de Gestion SETRAF
emoji: 🏢
colorFrom: blue
colorTo: green
sdk: docker
sdk_version: python:3.11
app_file: app.py
pinned: false
---

# ⚠️ AVERTISSEMENT DE SÉCURITÉ - LOGICIEL PROPRIÉTAIRE SETRAF ⚠️

**ATTENTION :** Ce logiciel est la propriété exclusive de SETRAF. Toute copie, distribution ou utilisation non autorisée est strictement interdite et peut entraîner des poursuites judiciaires.

## 🔒 Sécurité et Confidentialité

- **Fichier .env** : Contient des informations sensibles (clés API, mots de passe). Ne partagez jamais ce fichier.
- **Licence** : Consultez le fichier LICENSE pour les conditions d'utilisation.
- **Confidentialité** : Toutes les données traitées sont confidentielles.

## 🚫 Interdictions

- ❌ Copie du logiciel sur d'autres supports
- ❌ Partage avec des tiers
- ❌ Modification sans autorisation
- ❌ Utilisation en dehors du cadre professionnel SETRAF

# Système de Gestion Avancé

Application portable de gestion et analyse de données pour SETRAF.

## Fonctionnalités

- Authentification utilisateur via email OTP
